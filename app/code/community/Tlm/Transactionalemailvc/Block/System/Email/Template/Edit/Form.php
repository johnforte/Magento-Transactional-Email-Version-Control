<?php
class Tlm_Transactionalemailvc_Block_System_Email_Template_Edit_Form extends Mage_Adminhtml_Block_System_Email_Template_Edit_Form{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if($templateId){
    			$fieldset->addField('versioncontrol', 'select', array(
    		        'name'      => 'versioncontrol',
    		        'label'     => 'Load Version Controlled Template',
    		        'required'  => false,
    		        'values'    => Mage::helper('tlm_transactionalemailvc')->getRevisions($templateId),
                'after_element_html' => '<br /><small>Click save template after selecting a revision</small>',
    			));
		    }
